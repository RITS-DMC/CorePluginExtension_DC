...
], function (PluginControllerExtension, OverrideExecution,MessageToast, PluginEventConstants) {
    "use strict";

    return PluginControllerExtension.extend("rits.ext.custom.plugins.assemblyPluginExtension.PluginEventExtension", {
        ...
        getOverrideExecution: function(sOverrideMember) {
            if (sOverrideMember === PluginEventConstants.ON_WORKLIST_SELECT_EVENT) {
                ...
                return OverrideExecution.After; //After
        ...
        onAddPress: function(){
            sap.m.MessageToast.show("Assembled Components Successfully");
            // this.getController().showSuccessMessage("Assembled Components Successfully");
